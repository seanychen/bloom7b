...
def generate_prompt(data_point):
    ...
    prompt_with_input = "用户: {} {}\n系统: {}"
    prompt_without_input = "用户: {}\n系统: {}"
    if "input" in data_point.keys() and data_point["input"]:
        prompt = prompt_with_input.format(data_point['instruction'], data_point['input'], data_point['output'])
    else:
        prompt = prompt_without_input.format(data_point['instruction'], data_point['output'])
    return prompt
...
output_dir = "../bloom_lora"
train(base_model, data_path, output_dir)
